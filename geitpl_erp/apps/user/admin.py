...
from attendance.admin import LeaveCategoryTabularAdmin
...
class CustomUserAdmin(admin.ModelAdmin):
    ...
    list_display = ['full_name','email','parent','personal_email']
    ...
    model = CustomUser
    inlines = [LeaveCategoryTabularAdmin]
...
class RatingAdmin(admin.ModelAdmin):
    ...
    list_display = ['user','tl','rating','created_at','rating_provided']
...
admin.site.register(TlFeedback,RatingAdmin)
